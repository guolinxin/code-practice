package com.guo.practice.codepractice.problems.hard.exp;
...
public class BlackjackHighest {
    String BlackjackHighest(String[] strArr) {
        ...
        sort(cards, new Comparator<Card>() {
            @Override
...
//        System.out.print(c.BlackjackHighest(new String[] {"jack","ace"}));
        System.out.print(c.BlackjackHighest(new String[] {"two","three","ace","king"}));
//        System.out.print(c.BlackjackHighest(new String[] { "jack", "queen", "king"}));
//        System.out.print(c.BlackjackHighest(new String[] {"two", "three", "four", "five", "six", "seven", "eight", "nine", "ten", "jack", "queen", "king", "ace"}));
    }
}
