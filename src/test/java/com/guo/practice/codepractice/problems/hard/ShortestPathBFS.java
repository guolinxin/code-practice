...
public class ShortestPathBFS {
    ...
    private List<String> buildShortestPath(Map<String, Node> visited, Node sNode, Node eNode) {
        ...
        while (current != null) {
            ...
            current = getLeastWeightAdjacent(current);
        }
        return shortestPath;
    }

    private Node getLeastWeightAdjacent(Node node) {
    ...
    public List<String> shortestPath(String[] input, String start, String dest) {
        // creat nodes
        createNodes(input);
    ...
    public void testShortestPath() {
        ...
        List<String> list = shortestPath(s, "A", "D");
